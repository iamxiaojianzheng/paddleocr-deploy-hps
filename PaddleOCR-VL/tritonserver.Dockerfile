...
RUN mkdir -p "${HOME}/.paddlex/official_models" \
        ...
        && rm -f UVDoc_infer.tar PP-LCNet_x1_0_doc_ori_infer.tar PP-DocLayoutV3_infer.tar PaddleOCR-VL-1.6_infer.tar PP-OCRv4_server_seal_det_infer.tar PP-OCRv4_server_rec_infer.tar PP-Chart2Table_infer.tar  \
